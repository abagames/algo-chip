...
- `algo-chip` public exports (pipeline orchestration, SE generation, utility
  types, and session helpers such as `SoundEffectController`,
  `createAudioSession`, and `createVisibilityController`)
